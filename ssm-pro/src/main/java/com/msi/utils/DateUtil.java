...
import com.msi.core.exceptions.MsiException;
...
public class DateUtil {
     ...
     * @return DateLimitUtil
     */
    public static DateLimitUtil getDateLimit(String data){
        //时间计算
        ...
        if(!StringUtils.isBlank(data)){
            switch (data){
                ...
                case Constants.SEARCH_DATE_PRE_YEAR:
                    ...
                    break;
                default:
                    List<String> list = ToolsUtil.stringToArrayStr(data);
                    if(list.size() == 1){
                        throw new MsiException("选择时间参数格式错误，请在 " +
        ...
        return new DateLimitUtil(startTime, endTime);
    }
    ...
    public static List<String> getListDate(String data) {
        ...
        //获取30天的开始结束日期
        DateLimitUtil dateLimit = DateUtil.getDateLimit(data);
